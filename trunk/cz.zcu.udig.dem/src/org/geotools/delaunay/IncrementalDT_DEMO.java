...
import org.geotools.delaunay.contourlines.*;
import org.geotools.delaunay.beziersurface.*;
public class IncrementalDT_DEMO {
	...
	/*	 Coordinate x1 = new Coordinate(1,1,10);
		...
		*/ 
		  ...
		  */
	/*	 Coordinate x1 = new Coordinate((Math.random()*1000000),(Math.random()*1000000),(Math.random()*100));
		 triangulace.insertPoint(x1);
		 Coordinate x2 = new Coordinate((Math.random()*1000000),(Math.random()*1000000),(Math.random()*100));
		 triangulace.insertPoint(x2);
		 Coordinate x3 = new Coordinate((Math.random()*1000000),(Math.random()*1000000),(Math.random()*100));
		 triangulace.insertPoint(x3);
		 Coordinate x4 = new Coordinate((Math.random()*1000000),(Math.random()*1000000),(Math.random()*100));
		 triangulace.insertPoint(x4);			
 /*
		 /***************************************************************
	 ...
	 */
		...
		// triangles = TINWithFixedLines.countTIN(triangles,fixedLines);
		 ...
		 BezierSurface.countSurface(trianglesNew, triangles, 6);
