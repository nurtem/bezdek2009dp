...
class Bezier2 {
	...
	protected void setControlPoints(){
		...
		A111 = new Coordinate(countProjectOnToPlane(b120, normalOfPlane, A111, normalOfT));
	...
	protected Coordinate getElevation(double u, double v){
		double w = 1 - u - v;
		Coordinate point = new Coordinate ((w*b300.x+u*b030.x+v*b003.x),(w*b300.y+u*b030.y+v*b003.y));
		if (T1.contains(point)){
			return T1.getElevation(point);
		}
		else{
			if (T2.contains(point)){
				return T2.getElevation(point);
			}
			else {
				System.out.println("Jsem ve TRETIM");
				//if (T3.contains(point))
					return T3.getElevation(point);
			}
		}
	}
	...
	public void getBezierPatch(){
		T1 = new Bezier(b300,b030,G,b210,b120,A021,A012,A102,A201,A111);
		T2 = new Bezier(b030,b003,G,b021,b012,B102,B201,A012,A021,B111);
		T3 = new Bezier(b003,b300,G,b102,b201,A201,A102,B201,B102,C111);
	}
}
